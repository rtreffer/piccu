...
var ImageSources = []ImageSource{
	...
	},
	{
		...
		Codename:     "focal",
		Architecture: ARM64,
		URL:          "https://cdimage.ubuntu.com/ubuntu/releases/20.04.3/release/ubuntu-20.04.3-preinstalled-server-arm64+raspi.img.xz",
		// newer versions of the RPI2 use the 64bit CPU. It may or may not work. 20.04 advertises support for RPI2
		Raspberry:         []string{RPI2, RPI3, RPI4},
		Filesize:          729207404,
		ExtractedFilesize: 3368303616,
		Checksum:          "sha256:7e405f473d8a9e3254cd702edaeecd5509a85cde1e9e99e120f6c82156c6958f",
	...
	},
	{
		...
		Codename:          "focal",
		Architecture:      ARMHF,
		URL:               "https://cdimage.ubuntu.com/ubuntu/releases/20.04.3/release/ubuntu-20.04.3-preinstalled-server-armhf+raspi.img.xz",
		Raspberry:         []string{RPI2, RPI3, RPI4},
		Filesize:          693251748,
		ExtractedFilesize: 3057245184,
		Checksum:          "sha256:1984c349d5d6b74279402325b6985587d1d32c01695f2946819ce25b638baa0e",
		ImageChecksum:     "sha256:baed13489df6c62a45dd1fad6e384e830b157342aae64321627d76c5993594e5",
	},
	{
		Release:           "21.04",
		Codename:          "hirsute",
	...
	},
	{
		...
		Codename:     "jammy",
		Architecture: ARM64,
		URL:          "https://cdimage.ubuntu.com/ubuntu-server/daily-preinstalled/current/jammy-preinstalled-server-arm64+raspi.img.xz",
		Raspberry:    []string{RPI2, RPI3, RPI4},
	},
	{
		Release:      "22.04",
		Codename:     "jammy",
		Architecture: ARMHF,
		URL:          "https://cdimage.ubuntu.com/ubuntu-server/daily-preinstalled/current/jammy-preinstalled-server-armhf+raspi.img.xz",
		Raspberry:    []string{RPI2, RPI3, RPI4},
	},
}
